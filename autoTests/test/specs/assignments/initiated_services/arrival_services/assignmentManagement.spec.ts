...
const serviceName = "Assignment management"
const purchaseOrderDetails_1 = ["Roebuck Removals ", "Termination", "USD - US Dollar", "500", "testDescrpt1", startDate]
const purchaseOrderDetails_2 = ["Roebuck Removals", "Termination", "EUR - Euro", "800", "descrpt2", commonElements.getCurrentDatePlusDaysNo0Format(8)]
const salesOrderDetails_1 = ["Pre Assignment Briefing", "225", "descript1", startDate]
const salesOrderDetails_2 = ["Pre Assignment Briefing", "565", "2descript", commonElements.getCurrentDatePlusDaysNo0Format(10)]
const recurringPODetails = ["Roebuck Removals ", "Long Term Assignment", "USD - US Dollar", "50", "Weekly", "testDescrpt1"]


describe('Assignment management Service, documents and finance test', () => {

    before(async () => {
        await passSignIn.signIn();
    });

    it('Go to Services / Assignment management Page and check label', async () => {
