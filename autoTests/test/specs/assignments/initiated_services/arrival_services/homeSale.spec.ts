...
const serviceName = "Home sale"
const purchaseOrderDetails_1 = ["Roebuck Removals ", "BMA", "USD - US Dollar", "500", "testDescrpt1", startDate]
const purchaseOrderDetails_2 = ["Roebuck Removals", "BMA", "EUR - Euro", "800", "descrpt2", commonElements.getCurrentDatePlusDaysNo0Format(8)]
const salesOrderDetails_1 = ["Pre-Payment Penalties", "225", "descript1", startDate]
const salesOrderDetails_2 = ["Pre-Payment Penalties", "565", "2descript", commonElements.getCurrentDatePlusDaysNo0Format(10)]
const recurringPODetails = ["Roebuck Removals ", "Closing Fee", "USD - US Dollar", "50", "Weekly", "testDescrpt1"]


describe('Home sale Service, documents and finance test', () => {

    before(async () => {
        await passSignIn.signIn();
    });

    it('Go to Services / Home sale page and check label', async () => {
