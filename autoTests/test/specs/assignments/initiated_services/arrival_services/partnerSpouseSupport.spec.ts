...
import partnerSpouseSupport from '../../../../pageobjects/assignment/services/partnerSpouseSupport.page';
import assignmentsPage from '../../../../pageobjects/clients/assignments.page';
import clientsPage from '../../../../pageobjects/clients/clients.page';

const startDate = commonElements.getCurrentDateNo0Format()
const serviceName = "Partner/Spouse support"
...
const serviceDescription_1 = "testServiceDescription_1"
const serviceDescription_2 = "testServiceDescription_2"
const cost_1 = "500"
const cost_2 = "800"
const purchaseOrderDetails_1 = ["Roebuck Removals ", "K2 Managment Fee - Partner/Spouse Support", "USD - US Dollar", "500", "testDescrpt1", startDate]
const purchaseOrderDetails_2 = ["Roebuck Removals", "K2 Managment Fee - Partner/Spouse Support", "EUR - Euro", "800", "descrpt2", commonElements.getCurrentDatePlusDaysNo0Format(8)]
const salesOrderDetails_1 = ["Partner/Spouse Support Service", "225", "descript1", startDate]
const salesOrderDetails_2 = ["Partner/Spouse Support Service", "565", "2descript", commonElements.getCurrentDatePlusDaysNo0Format(10)]
const recurringPODetails = ["Roebuck Removals ", "Partner/Spouse Support - Other", "USD - US Dollar", "50", "Weekly", "testDescrpt1"]


describe('Partner/Spouse support test', () => {

    before(async () => {
        await passSignIn.signIn();
    });

    it('Go to Services / Partner/Spouse support Page and check label', async () => {
    ...
    it('VerifyPartner/Spouse support Initiation details form', async () => {
        ...
        await partnerSpouseSupport.setServiceDescription(serviceDescription_1);
        await partnerSpouseSupport.setCost(cost_1);
        ...
        expect(await partnerSpouseSupport.getServiceDescriptionValue()).toBe(serviceDescription_1);
        expect(await partnerSpouseSupport.getCostValue()).toBe(cost_1);
    });
        ...
        await partnerSpouseSupport.setServiceDescription(serviceDescription_2);
        await partnerSpouseSupport.setCost(cost_2);
        await commonElements.refreshPage();
        expect(await initiatedServicesPage.getContactPersonValue()).toBe(contactPerson_1);
        expect(await initiatedServicesPage.getNotesToPartnerValue()).toBe(notes_1);
        expect(await partnerSpouseSupport.getServiceDescriptionValue()).toBe(serviceDescription_1);
        ...
        expect(await partnerSpouseSupport.getServiceDescriptionValue()).toBe(serviceDescription_2);
        expect(await partnerSpouseSupport.getCostValue()).toBe(cost_2);
    });
