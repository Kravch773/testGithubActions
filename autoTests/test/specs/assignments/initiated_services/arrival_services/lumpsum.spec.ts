...
const serviceName = "Lumpsum"
const purchaseOrderDetails_1 = ["Roebuck Removals ", "K2 Fee - Lump Sum", "USD - US Dollar", "500", "testDescrpt1", startDate]
const purchaseOrderDetails_2 = ["Roebuck Removals", "K2 Fee - Lump Sum", "EUR - Euro", "800", "descrpt2", commonElements.getCurrentDatePlusDaysNo0Format(8)]
const salesOrderDetails_1 = ["K2 Fee - Lump Sum", "225", "descript1", startDate]
const salesOrderDetails_2 = ["K2 Fee - Lump Sum", "565", "2descript", commonElements.getCurrentDatePlusDaysNo0Format(10)]
const recurringPODetails = ["Roebuck Removals ", "K2 Fee - Lump Sum", "USD - US Dollar", "50", "Weekly", "testDescrpt1"]
