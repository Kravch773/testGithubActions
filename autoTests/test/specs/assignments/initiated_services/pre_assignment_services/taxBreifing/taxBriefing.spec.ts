...
const serviceName = "Tax briefing"
...
const purchaseOrderDetails_1 = ["Roebuck Removals ", "K2 Managment Fee - Tax Briefing", "USD - US Dollar", "500", "testDescrpt1", startDate]
const purchaseOrderDetails_2 = ["Roebuck Removals", "K2 Managment Fee - Tax Briefing", "EUR - Euro", "800", "descrpt2", commonElements.getCurrentDatePlusDaysNo0Format(8)]
const salesOrderDetails_1 = ["Tax Briefing Service", "225", "descript1", startDate]
const salesOrderDetails_2 = ["Tax Briefing Service", "565", "2descript", commonElements.getCurrentDatePlusDaysNo0Format(10)]
const recurringPODetails = ["Roebuck Removals ", "Tax Briefing - Other", "USD - US Dollar", "50", "Weekly", "testDescrpt1"]


describe('TaxBriefing  Service, documents and finance test', () => {

    before(async () => {
        await passSignIn.signIn();
    });

    it('Go to Services / TaxBriefing page and check label', async () => {
