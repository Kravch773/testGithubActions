...
const salesOrderDetails_1 = ["Vehicle Move", "225", "descript1", startDate]
const salesOrderDetails_2 = ["Vehicle Move", "565", "2descript", commonElements.getCurrentDatePlusDaysNo0Format(10)]
const recurringPODetails = ["Roebuck Removals ", "Vehicle Move", "USD - US Dollar", "50", "Weekly", "testDescrpt1"]
