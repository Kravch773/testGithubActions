...
const serviceName = "Pet move"
const purchaseOrderDetails_1 = ["Roebuck Removals ", "Pet Move", "USD - US Dollar", "500", "testDescrpt1", startDate]
const purchaseOrderDetails_2 = ["Roebuck Removals", "Pet Move", "EUR - Euro", "800", "descrpt2", commonElements.getCurrentDatePlusDaysNo0Format(8)]
const salesOrderDetails_1 = ["K2 -Management Fee Pet Move", "225", "descript1", startDate]
const salesOrderDetails_2 = ["K2 -Management Fee Pet Move", "565", "2descript", commonElements.getCurrentDatePlusDaysNo0Format(10)]
const recurringPODetails = ["Roebuck Removals ", "Pet Move", "USD - US Dollar", "50", "Weekly", "testDescrpt1"]


describe('Pet move Service, documents and finance test', () => {

    before(async () => {
        await passSignIn.signIn();
    });

    it('Go to Services / Pet move page and check label', async () => {
