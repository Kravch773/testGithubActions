...
const purchaseOrderDetails_1 = ["Roebuck Removals ", "K2 Management Fee - Departure Services", "USD - US Dollar", "500", "testDescrpt1", startDate]
const purchaseOrderDetails_2 = ["Roebuck Removals", "K2 Management Fee - Departure Services", "EUR - Euro", "800", "descrpt2", commonElements.getCurrentDatePlusDaysNo0Format(8)]
const salesOrderDetails_1 = ["Cleaning", "225", "descript1", startDate]
const salesOrderDetails_2 = ["Cleaning", "565", "2descript", commonElements.getCurrentDatePlusDaysNo0Format(10)]
const recurringPODetails = ["Roebuck Removals", "Departure- Other", "USD - US Dollar", "50", "Weekly", "testDescrpt1"]
