...
const serviceName = "Home sale assistance"
const purchaseOrderDetails_1 = ["Roebuck Removals ", "ACQUISTION - Appraisals", "USD - US Dollar", "500", "testDescrpt1", startDate]
const purchaseOrderDetails_2 = ["Roebuck Removals", "ACQUISTION - Appraisals", "EUR - Euro", "800", "descrpt2", commonElements.getCurrentDatePlusDaysNo0Format(8)]
const salesOrderDetails_1 = ["ACQUISTION - Appraisals", "225", "descript1", startDate]
const salesOrderDetails_2 = ["ACQUISTION - Appraisals", "565", "2descript", commonElements.getCurrentDatePlusDaysNo0Format(10)]
const recurringPODetails = ["Roebuck Removals ", "ACQUISTION - Appraisals", "USD - US Dollar", "50", "Weekly", "testDescrpt1"]


describe('Home sale assistance Service, documents and finance test', () => {

    before(async () => {
        await passSignIn.signIn();
    });

    it('Go to Services / Home sale assistance page and check label', async () => {
