...
const serviceName = "Utility management"
...
const purchaseOrderDetails_1 = ["Roebuck Removals ", "Monthly Rent", "USD - US Dollar", "500", "testDescrpt1", startDate]
const purchaseOrderDetails_2 = ["Roebuck Removals", "Monthly Rent", "EUR - Euro", "800", "descrpt2", commonElements.getCurrentDatePlusDaysNo0Format(8)]
const salesOrderDetails_1 = ["Cleaner", "225", "descript1", startDate]
const salesOrderDetails_2 = ["Cleaner", "565", "2descript", commonElements.getCurrentDatePlusDaysNo0Format(10)]
const recurringPODetails = ["Roebuck Removals ", "Rental Rebate", "USD - US Dollar", "50", "Weekly", "testDescrpt1"]
