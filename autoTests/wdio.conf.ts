export const config: WebdriverIO.Config = {
    ...
    specs: ['./test/specs/assignments/assignment_tabs/*.spec.ts'],
    // ...
    ...
    suites: {
        ...
        clientPageTabs: [
            './test/specs/clientPage/client_documents.spec.ts'
        ],
        clientSetupPage: [
        ...
        preAssignmentServices: [
            './test/specs/assignments/initiated_services/pre_assignment_services/homeSearchNA_Property.spec.ts'
        ],
        universalServices: [
            './test/specs/assignments/initiated_services/universal_services/*.spec.ts'
        ],
        onAssignment: [
            './test/specs/assignments/initiated_services/onAssignment/utilityManagement.spec.ts'
        ]
        
    },
    // Patterns to exclude.
    exclude: [
        './test/specs/Assignment/assignee/4.Addresses.spec.ts',
        './test/specs/ClientPage/InitiateNewAssignment.spec.ts'
    ],
    //
    // ============
    // Capabilities
