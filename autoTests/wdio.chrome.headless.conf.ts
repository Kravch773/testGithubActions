export const config: WebdriverIO.Config = {
    ...
    suites: {
        ...
        clientPageTabs: [
            './test/specs/client_page/*.spec.ts'
        ],
        client_SetupPage: [
            './test/specs/client_page/setup_page/*.spec.ts'
        ],
        initiatedServices: [
            './test/specs/assignments/initiated_services/*/TempAccommodation(Destination).spec.ts'
        ]

    },
    // Patterns to exclude.
    exclude: [
        // './test/specs/Assignment/assignee/2.Addresses.spec.ts',
